...
\label{apendice_timer1}

\lstinputlisting[label=alg:timer1, caption={Projeto \textit{Timer1}.},language=C]{./Code/Timer1.c}

\chapter{Projeto \textit{Blink} em assembly para o simulador \textit{AndMCU}}
\label{apendice_blink_asm}

\lstinputlisting[label=alg:blinkasm, caption={Projeto \textit{Blink} em assembly para simulador \textit{AndMCU}.},language=C]{./Code/BlinkAsm.asm}
%\begin{center}
