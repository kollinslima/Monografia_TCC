...
\label{apendice_blink}

\lstinputlisting[label=alg:blink_led, caption={Projeto \textit{Blink}, utilizado para teste manual do frequencímetro, módulo de saída e como projeto base para comparação entre aplicativos.},language=C]{./Code/Blink.c}

\chapter{Projeto \textit{Blink} em assembly}
\label{apendice_blink_asm}

\lstinputlisting[label=alg:blinkasm, caption={Projeto \textit{Blink} em assembly para ser utilizado no simulador \textit{AndMCU}.},language=C]{./Code/BlinkAsm.asm}

\chapter{Projeto \textit{Input to Output}}

\lstinputlisting[label=alg:input_to_output, caption={Projeto \textit{Input to Output}, utilizado para teste manual do módulo de E/S.},language=C]{./Code/Input_to_Output.c}

\chapter{Projeto \textit{Interrupt}}

\lstinputlisting[label=alg:interrupt, caption={Projeto \textit{Interrupt}, utilizado para teste manual de interrupções externas e do resistor de \textit{pull-up}.},language=C]{./Code/Interrupt.c}

\chapter{Projeto \textit{Timer}}
\label{apendice_timer}

\lstinputlisting[label=alg:timer1, caption={Projeto \textit{Timer}, utilizado para testar os temporizadores. O código mostrado está configurado para testar o \textit{Timer1}.},language=C]{./Code/Timer1.c}

\chapter{Projeto \textit{Analog Input}}

\lstinputlisting[label=alg:analoginput, caption={Projeto \textit{Analog Input}, utilizado para testar o canal analógico.},language=C]{./Code/AnalogInput.c}

\chapter{Projeto \textit{Serial}}

\lstinputlisting[label=alg:serial, caption={Projeto \textit{Serial}, utilizado para testar a USART e o monitor serial.},language=C]{./Code/Serial.c}

\chapter{Projeto \textit{Analog Serial}}

\lstinputlisting[label=alg:analogserial, caption={Projeto \textit{Analog Serial}, utilizado para testar a integração entre USART e canal analógico, bem como uma referência externa para o conversor A/D.},language=C]{./Code/AnalogSerial.c}

\chapter{Projeto \textit{Memory Measure}}

\lstinputlisting[label=alg:memorymeasure, caption={Projeto \textit{Memory Measure}, utilizado para testar o medidor de memória.},language=C]{./Code/MemoryMeasure.c}
