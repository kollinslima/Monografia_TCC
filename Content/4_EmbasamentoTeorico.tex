...
\par Neste capítulo será explicado o funcionamento e as características de cada módulo presente no microcontrolador usado no Arduino UNO (ATmega328P) e que foram implementados no simulador. Todas as informações foram retiradas da folha de dados do componente~\cite{atmega328p_datasheet}, exceto onde indicado.
