...
\begin{itemize}
	...
	\item Uma interface serial TWI (Two-Wire Serial Interface), compatível com $I^{2}C$ (\textit{Inter-Integrated Circuit}) da Philips;
