...
\item Por fim, em termos de hardware, foi utilizado um Arduino UNO R3 para comparar os resultados obtidos pelo aplicativo com o sistema real, principalmente comparações feitas em medidas de frequência e \textit{duty cycle}, no qual se fez uso também de um osciloscópio InfiniiVision DSOX2002A, da Keysight.
\end{itemize}
