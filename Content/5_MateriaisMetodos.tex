...
\item Para a criação dos gráficos, foram utilizados \textit{scripts} em \href{https://www.python.org/}{\textit{Python}}, fazendo uso da biblioteca \href{https://matplotlib.org/}{\textit{Matplotlib}}. Também foi utilizado o \href{https://www.google.com/sheets/about/}{\textit{Google Sheets}} para esta função.
