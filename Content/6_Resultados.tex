...
\par A velocidade de simulação aqui apresentada é uma medida da percepção que o usuário tem desta velocidade, uma vez que é difícil fazer uma medição mais exata da frequência efetiva de \textit{clock} de cada simulador (até porque não se tem o código dos demais simuladores).
