...
\section{Características e limitações}

\par Como é de se esperar, o sistema desenvolvido possui diversas limitações em comparação com o sistema real, a começar pela quantidade de módulos desenvolvidos e seus modos de operação, que cobrem apenas as principais funcionalidades de um Arduino.

\par Provavelmente, a principal limitação do sistema é sua velocidade. 
