...
\par O código-fonte do projeto foi disponibilizado em um repositório \textit{on-line} no Github sob a licença \textit{Apache 2.0}. As modificações feitas na IDE do Arduino também estão disponíveis no Github sob a mesma licença do projeto original (GPL v2.0).
