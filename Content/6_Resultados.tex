...
\begin{table}[p]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
		...
		&                   & \multirow{2}{*}{Teórico} & \multicolumn{2}{c|}{SOFIA} & \multicolumn{2}{c|}{Arduino} & \multirow{2}{*}{SOFIA} & \multirow{2}{*}{Arduino} \\ \cline{4-7}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.55]{./Resources/simulation_with_io}
...
\par Além disso, o projeto SOFIA busca ser um simulador genérico, permitindo que o usuário entre com qualquer código hexadecimal gerado, independente de sua fonte.
...
\begin{figure}[h!]
	...
	\caption{Consumo médio de Bateria (\%) de cada aplicativo em um período de 2 horas, com cada aplicativo executando o projeto \textit{Blink} continuamente por 30 minutos.} 
	Fonte: Autor
