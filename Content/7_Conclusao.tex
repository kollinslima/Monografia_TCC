...
\par Quanto à qualidade do sistema, a análise estática do \href{https://www.sonarqube.org/}{\textit{SonarQube}} não revelou grandes problemas no código e os principais módulos foram quase que totalmente cobertos por teste. Ainda é preciso a criação de muitos casos de teste para cobrir todo o projeto e garantir um nível maior de qualidade, estes estão sendo desenvolvidos em ordem de prioridade para os demais módulos.
